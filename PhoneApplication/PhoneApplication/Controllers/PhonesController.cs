...
namespace PhoneApplication.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PhoneID,ManufacturerID,PhoneName,MSRP,ScreenSize,DateReleased")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PhoneID,ManufacturerID,PhoneName,MSRP,ScreenSize,DateReleased")] Phone phone)
        {
            if (ModelState.IsValid)
            {
